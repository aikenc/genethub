...
defineSpecialty({
  ...
  tags: ["network-risk-v2", "network-v2-diagnostic", "page-experience", "client-debug"], runner: "playwright", llm: { default: "none" },
  ...
  try {
    ...
    phase = "browser wall clock expiration";
