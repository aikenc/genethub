...
export type AgentCapability = "planning" | "coding" | "multimodal";
 ...
 */
export type AgentRuntimePreference = { effortId?: string, fast?: boolean, modeId?: string, runtimeValues: { [key in string]?: string }, };
 ...
 */
workspaceId?: string, modelId?: string, modeId?: string, effortId?: string, fast?: boolean, 
/**
 ...
 */
recentRounds?: number, } } | { "type": "unsubscribe", "payload": { sessionId: string, } } | { "type": "agent.list" } | { "type": "agent.refresh" } | { "type": "session.create", "payload": { workspaceId: string, agentId: string, modelId: string | null, effortId?: string, fast?: boolean, modeId: string | null, runtimeValues?: { [key in string]?: string }, title: string | null, 
/**
 ...
 */
packageId?: string, candidateDigest?: string, } } | { "type": "workflow.list", "payload": { workspaceId: string, } } | { "type": "workflow.build", "payload": { workspaceId: string, packageId: string, apply: boolean, 
/**
 ...
 */
expectedRevision: number | null, } } | { "type": "workflow.activate", "payload": { workspaceId: string, 
/**
 * Required once a project holds more than one package.
 */
 ...
 */
executionRoot?: string, taskId: string, prompt: string, } } | { "type": "workflow.check", "payload": { workspaceId: string, runId: string | null, 
/**
 ...
 */
export type SessionAgentTarget = { agentId: string, modelId?: string, modeId?: string, effortId?: string, fast?: boolean, runtimeValues: { [key in string]?: string }, };
 ...
 */
export type SessionDraft = { id: string, text: string, attachments: Array<Attachment>, 
/**
 * Forward provenance is presentation metadata only; `text` remains the
 * complete editable payload that will be sent.
 */
forward?: SessionDraftForward, };

export type SessionDraftForward = { sourceSessionId: string, sourceTitle?: string, itemCount: number, estimatedTokens: number, };
 ...
 */
messagePreview?: SessionMessagePreview, 
/**
 ...
 */
title?: string, status: SessionStatus, modelId?: string, modeId?: string, effortId?: string, fast?: boolean, runtimeValues?: { [key in string]?: string }, createdAtMs: number, updatedAtMs: number, archived: boolean, 
/**
 ...
 */
agentPreferences?: AgentSelectionPreferences, };
 ...
 */
components: Array<string>, planDigest: string, expectedRevision: number, 
/**
 * Runs that must finish before a rebuild may replace shared carriers.
 */
conflictRuns: Array<string>, 
/**
...
export type WorkflowCatalogEntryStatus = { id: string, path: string, digest: string, };
 ...
 */
export type WorkflowDraftReport = { schema: string, root: string, valid: boolean, truncated: boolean, diagnostics: Array<WorkflowDiagnostic>, candidateDigest: string | null, 
/**
 ...
 */
export type WorkflowPackageStatus = { 
/**
 ...
 */
spaces: Array<WorkflowPackageSpaceStatus>, 
/**
 ...
 */
dev: boolean, root: string, workflows: Array<WorkflowCatalogEntryStatus>, 
/**
