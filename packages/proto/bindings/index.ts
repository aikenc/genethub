...
import type { PmImprovementCandidateStatus } from "./PmImprovementCandidateStatus";
 ...
 */
cwd: string | null, } } | { "type": "pm.session.create", "payload": { workspaceId: string, modelId: string | null, modeId: string | null, 
/**
