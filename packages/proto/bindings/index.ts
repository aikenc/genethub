...
export type PmAgentSpaceStatus = { name: string, purpose: string, workspaceId: string, sourceCommit: string, builderLockDigest: string, role: string, active: boolean, };
 ...
 */
export type PmProjectStatus = { workspaceId: string, controllerSessionId: string, phase: string, lifecycle: string, revision: number, intent?: PmIntentStatus, workPackages: Array<PmWorkPackageStatus>, agentSpaces: Array<PmAgentSpaceStatus>, supervisor: PmSupervisorStatus, updatedAtMs: number, };

export type PmSupervisorStatus = { mode: string, nextCheckAtMs?: number, wakePending: boolean, };

export type PmWorkPackageStatus = { id: string, title: string, outcome: string, status: string, dependencies: Array<string>, agentSpace: string, branch: string, workSessionId?: string, candidateCommit?: string, candidateTree?: string, reviewSessionId?: string, reviewVerdict?: string, blockReason?: string, };
