...
use genehub_proto::{
    ...
    InstallMethod, ItemDelta, LoginGuide, ModeInfo, ModelInfo, PermissionOption,
    PermissionOptionKind, PermissionOutcome, PermissionRequest, PermissionRequestKind, ProbeState,
    SessionEvent, TimelineItem, TodoEntry, TodoStatus, ToolCallDetail, ToolStatus, TurnError,
    TurnErrorCode, Usage,
};
