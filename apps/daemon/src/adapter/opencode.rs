...
use genehub_proto::{
    AgentSetup, ApiKeyGuide, ApiKeyKind, Capabilities, Catalog, GuidePlatform, InstallMethod,
    LoginGuide, ModeInfo, ModelInfo, PermissionOutcome, ProbeState, SessionEvent, TimelineItem,
